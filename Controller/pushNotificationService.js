...
//// Ensure you have the Firebase service account key JSON file in the `config` directory
...
//    console.log("Push notification batch sent successfully:", response);
//    return response; // Returns batch response with success/failure counts
//  } catch (error) {
