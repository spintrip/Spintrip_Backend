...
const {getprofile, putprofile, uploadProfile, getAllVehicleTypes, deleteuser, getaddress, postaddress, verifyAadhar, verifyDl, verifyPan} = require('./userProfile');
...
module.exports = {
    signup , login, verify, getprofile, putprofile, uploadProfile, getAllVehicleTypes, deleteuser, getbrand, features, findvehicles, onevehicle, getvehicleadditional, 
