...
const { getAllBookings, getSelfDriveBookings, getCabBookings, getBookingById, updateBookingById, deleteBookingById, cancelCabBooking, sendCabInvoice, createAdminBooking, broadcastCabBooking } = require('./bookingManagement');
...
const { createVehicleType, getAllVehicleTypes, deleteVehicleType, updateVehicleType } = require('./adminVehicleTypeManagement');
...
module.exports = {
  ...
  getAllBookings, getSelfDriveBookings, getCabBookings, getBookingById, updateBookingById, deleteBookingById, cancelCabBooking, sendCabInvoice, broadcastCabBooking,
